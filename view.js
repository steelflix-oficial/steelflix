...
async function openModal(id) {
    ...
    if (customItem && customItem._hasFile && !customItem.video) {
        ...
        if (blob) {
            ...
            videoPlayer.innerHTML = '<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;color:#ff6b6b;gap:10px;"><i class="fas fa-exclamation-triangle" style="font-size:2rem;"></i><p style="font-size:1.1rem;">Video no encontrado.</p></div>';
        }
